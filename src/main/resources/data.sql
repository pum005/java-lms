...
INSERT INTO session_image (id, image_size, type, width, height) VALUES (0L, 1000000, 'jpg', 300, 200);

INSERT INTO session (id, session_image_id, session_state, price, max_capacity, start_date, end_date) VALUES (0L, 0L, 'RECRUITING', 10000, 200, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());